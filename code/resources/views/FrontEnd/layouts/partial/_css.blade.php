<link rel="stylesheet" href="{{ url('css/frontend/css/') }}/bootstrap.min.css">
<link rel="stylesheet" href="{{ url('css/frontend/css/') }}/magnific-popup.css">
<link rel="stylesheet" href="{{ url('css/frontend/css/') }}/owl.carousel.min.css">
<link rel="stylesheet" href="{{ url('css/frontend/css/') }}/font-awesome.min.css">
